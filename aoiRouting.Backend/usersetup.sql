-- \i 'D:\\Desktop\\aoiRouting\\aoiRouting.Backend\\usersetup.sql'

-- -- drop table aoi cascade;
-- create table if not exists aoi
-- (
--     userid uuid not null constraint aoi_userid primary key,
--     friendlyname varchar(255) not null,
--     email varchar(255) not null constraint aoi_email unique,
...
--     userid uuid not null constraint credentials_userid references aoi,
--     kind integer not null,
...
--     author uuid not null constraint pins_author references aoi,
...
--     author uuid not null constraint locs_author references aoi,
--     title varchar(255) not null,
--     lat double precision[] not null,
...
--     author uuid not null constraint comments_author references aoi,
